...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full px-6 md:px-20 py-5 flex items-center justify-between font-['Neue Montreal'] z-[99] bg-zinc-900/80 backdrop-filter backdrop-blur-lg border-b border-zinc-800/50 shadow-lg">
            {/* Logo Section */}
